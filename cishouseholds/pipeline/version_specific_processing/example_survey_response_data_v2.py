...
def example_survey_response_data_v2_transformations(df: DataFrame) -> DataFrame:
    """Wrapper function for example survey response data v2 transformations"""
...
def pre_processing(df: DataFrame) -> DataFrame:
    """
    Pre processing tasks creating raw columns and remapping values
    """
...
def derive_additional_columns(df: DataFrame) -> DataFrame:
    """Derive additional columns for version 2 of the example survey response data"""
